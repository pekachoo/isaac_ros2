...
launch_args = [
    ...
    DeclareLaunchArgument('gui', default_value='/home/jliu/isaac_ws/src/sim_pkg/sim_pkg/assets/bb_world_policy.usd', description='Provide the path to a usd file to open it when starting Isaac Sim in standard gui mode. If left empty, Isaac Sim will open an empty stage in standard gui mode.'),
