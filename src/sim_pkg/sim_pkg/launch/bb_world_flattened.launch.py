...
launch_args = [
    ...
    DeclareLaunchArgument('gui', default_value='/home/jliu/isaac_ws/src/sim_pkg/sim_pkg/assets/bracketbot_flattened.usd', description='Provide the path to a usd file to open it when starting Isaac Sim in standard gui mode. If left empty, Isaac Sim will open an empty stage in standard gui mode.'),
...
def launch_setup(context):
    ...
    # run it as a node instead of an executable script
    isaacsim_node = Node(
        package='sim_pkg', executable='run_isaacsim',
